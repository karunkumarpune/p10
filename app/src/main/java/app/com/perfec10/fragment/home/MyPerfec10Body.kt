...
class MyPerfec10Body : AppCompatActivity() {
   override fun onCreate(savedInstanceState: Bundle?) {
      ...
      view_tab1.setBackgroundColor(resources.getColor(R.color.colorPrimary))
      view_tab2.setBackgroundColor(resources.getColor(R.color.colorAccent))
      ...
      btn_male.setOnClickListener {
         view_tab1.setBackgroundColor(resources.getColor(R.color.colorAccent))
         view_tab2.setBackgroundColor(resources.getColor(R.color.colorPrimary))
         supportFragmentManager.beginTransaction()
